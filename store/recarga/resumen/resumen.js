...
export const state = () => ({
  ...
  ordenamientos:[
    ...
    {index:3, nombre:'es_turnante_value', order:'ASC'},
    {index:4, nombre:'calculo_contrato', order:'ASC'},
    {index:5, nombre:'recarga_contratos.unidads.nombre', order:'ASC'},
    {index:6, nombre:'recarga_contratos.unidads.c_costo', order:'ASC'},
    {index:7, nombre:'calculo_turno', order:'ASC'},
    {index:8, nombre:'calculo_grupo_uno', order:'ASC'},
    {index:9, nombre:'calculo_grupo_dos', order:'ASC'},
    {index:10, nombre:'calculo_grupo_tres', order:'ASC'},
    {index:11, nombre:'calculo_viaticos', order:'ASC'},
    {index:12, nombre:'calculo_dias_ajustes', order:'ASC'},
    {index:13, nombre:'total_dias_cancelar', order:'ASC'},
    {index:14, nombre:'total_monto_ajuste', order:'ASC'},
    {index:15, nombre:'monto_total_cancelar', order:'ASC'},
  ],
