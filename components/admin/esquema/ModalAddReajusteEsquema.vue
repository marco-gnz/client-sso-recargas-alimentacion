    ...
    <div class="modal is-large" :class="openModalReajuste ? 'is-active' : '' ">
      ...
      <div class="modal-card" style="width: 50%;">
        ...
        <section class="modal-card-body">
          <div class="columns">
            <div class="column">
              <p class="subtitle">{{ `${esquema != null ? `${esquema.funcionario_nombre_completo}` : ``}` }}</p>
              <div class="field">
                <div class="columns">
                  <div class="column">
                    <div class="field">
...
export default {
  ...
  computed:{
      ...mapGetters({
        openModalReajuste: "esquemas/esquemaFuncionario/modalReajuste",
        tiposDeAusentismo: "modulos/modulos/tiposAusentismos",
        tiposIncrementos: "modulos/modulos/tiposIncrementos",
        loadingReajuste:"esquemas/esquemaFuncionario/loadingReajuste",
      ...
      fecha_inicio:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.fecha_inicio;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_FECHA_INICIO', newValue);
        }
      },
      fecha_termino:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.fecha_termino;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_FECHA_TERMINO', newValue);
        }
      },
      total_dias:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.total_dias;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_TOTAL_DIAS', newValue);
        }
      },
      calculo_dias:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.calculo_dias;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_CALCULO_DIAS', newValue);
        }
      },
      rebaja_dias:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.rebaja_dias;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_REBAJA_DIAS', newValue);
        }
      },
      tipo_ausentismo:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.tipo_ausentismo_id;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_TIPO_AUSENTISMO', newValue);
        }
      },
      tipo_incremento:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.tipo_incremento_id;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_TIPO_INCREMENTO', newValue);
        }
      },
      advertencias:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.advertencias;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_ADVERTENCIAS', newValue);
        }
      },
      errores:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.errores;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_ERRORES', newValue);
        }
      },
      valor_dia:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.valor_dia;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_VALOR_DIA', newValue);
        }
      },
      observacion:{
        get() {
          return this.$store.state.esquemas.esquemaFuncionario.reajuste.observacion;
        },
        set(newValue) {
          this.$store.commit('esquemas/esquemaFuncionario/SET_REAJUSTE_OBSERVACION', newValue);
        }
      },
    },
    methods:{
      ...mapActions({
        ...
        storeReajusteAction:'esquemas/esquemaFuncionario/storeReajusteEsquema',
        getDaysInDate:'esquemas/esquemaFuncionario/getDaysInDate',
