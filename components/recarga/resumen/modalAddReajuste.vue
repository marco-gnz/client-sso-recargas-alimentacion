...
import calculo from '../ajustes/calculo.vue';
export default {
  components: { calculo },
  ...
  computed:{
    ...mapGetters({
      ...
      diffDays:'recarga/resumen/resumen/diffDays',
      loadingPreCalculo:'recarga/resumen/resumen/loadingPreCalculo'
    }),
    currentRouteName() {
    ...
    new_esquema_calculo(){
      return this.$store.state.recarga.resumen.resumen.reajuste.calculo;
    },
    fecha_inicio:{
      get() {
    ...
    total_dias:{
      get() {
        return this.$store.state.recarga.resumen.resumen.reajuste.total_dias;
      },
      set(newValue) {
        this.$store.commit('recarga/resumen/resumen/SET_REAJUSTE_TOTAL_DIAS', newValue);
      }
    },
    calculo_dias:{
      get() {
  ...
  methods:{
    ...mapActions({
      ...
      getMontoInDays:'recarga/resumen/resumen/getMontoInDays'
    }),
